...
const Api = (() => {
  ...
  const TIMEOUT_MS = 15000; // au-delà, on abandonne plutôt que de tourner indéfiniment
  ...
  async function call(action, payload = {}) {
    ...
    try {
      ...
      if (err && err.name === "AbortError") {
        return { ok: false, error: "Le serveur met trop de temps à répondre (plus de 15s). Réessayez dans un instant." };
      }
